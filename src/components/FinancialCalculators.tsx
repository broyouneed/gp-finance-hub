...
import { Calculator, IndianRupee, TrendingUp, PiggyBank } from "lucide-react";
...
export const FinancialCalculators = () => {
  ...
  return (
    <section id="calculators" className="section-padding bg-card" ref={ref}>
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
            ...
            Get instant estimates for loan EMIs and SIP returns.
          </p>
        ...
        >
          {activeTab === "emi" ? <EMICalculatorContent /> : <SIPCalculatorContent />}
        </motion.div>
      </div>
    </section>
  );
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-secondary font-bold text-lg">{expectedReturn}%</span>
            </div>
            <Slider
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-secondary font-bold text-lg">{timePeriod} years</span>
            </div>
            <Slider
              value={[timePeriod]}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-secondary/10 rounded-2xl p-6 text-center">
            ...
            <p className="text-4xl md:text-5xl font-bold text-secondary flex items-center justify-center gap-1">
              <IndianRupee className="w-8 h-8" />
